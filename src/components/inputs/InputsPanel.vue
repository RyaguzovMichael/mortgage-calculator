  ...
  <aside class="panel">
    ...
    <section>
      ...
      <PercentField
        ...
        :step="1"
        hint="Год к году: 12% = через год цена выше на 12%. Применяется каждый год на всём горизонте — подставляйте долгосрочное среднее, а не пиковый год. Порог переворота выводов ≈ 9%. При росте > 0 сравнивайте по чистым активам, не по потере."
      />
    </section>

    <section>
      <h3>Продажа текущей квартиры</h3>
      <NumberField v-model="inputs.sale.proceeds" label="Сумма" suffix="₸" :step="500000" />
      <NumberField
    ...
    <section>
      ...
      <NumberField
        ...
        suffix="₸"
        :step="50000"
        hint="Платится только пока квартира продана, а новая не куплена."
      />
      <NumberField
