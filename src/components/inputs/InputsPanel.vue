  ...
  <aside class="panel">
    ...
    <section>
      ...
      <PercentField
        ...
        :step="1"
        hint="Год к году: 12% = через год цена выше на 12%. Применяется каждый год на всём горизонте — подставляйте долгосрочное среднее, а не пиковый год. Этой же ставкой индексируется аренда. Порог переворота выводов ≈ 8%. При росте > 0 сравнивайте по чистым активам, не по потере."
      />
    </section>
